 ...
 *
 * Collapsed from two separate steps (Start Progress → Resolved) into one:
 * clicking "Mark Resolved" transitions directly to RESOLVED regardless of
 * whether the ticket is OPEN or IN_PROGRESS.
 *
...
function EmployeeStatusActions({
  ...
  // Only show when ticket is actionable — tickets start as IN_PROGRESS on creation
